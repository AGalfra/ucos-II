...
//    GPIO_Init(GPIOB, &gpio_init);
	...
	/*Configure GPIO pins : PA0, PA1, PA2  como SALIDAS */
	...
	/*Configure GPIO pins : PB0, PB1, PB3 como ENTRADAS */
...
* Arguments   : None.
* Returns     : None.
* NOTAS       : Utilizo los pines del puerto B como entradas.
*********************************************************************************************************
*/
void  DIRd (void) {
    DIO_DI	*pdi;
    ...
    in = GPIOB->IDR;									/* Read the physical port (8 bits)          */
...
* Arguments   : None.
* Returns     : None.
* NOTAS       : Utilizo los pines del puerto A como Salidas.
*********************************************************************************************************
*/
void  DOWr (void) {
    DIO_DO  *pdo;
